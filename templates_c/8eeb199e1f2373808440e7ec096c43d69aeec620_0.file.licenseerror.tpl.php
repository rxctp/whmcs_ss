<?php
/* Smarty version 3.1.29, created on 2017-04-16 23:08:02
  from "/project/vpn/whmcs/admin/templates/licenseerror.tpl" */

if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  'has_nocache_code' => false,
  'version' => '3.1.29',
  'unifunc' => 'content_58f388d270d0c8_35070087',
  'file_dependency' => 
  array (
    '8eeb199e1f2373808440e7ec096c43d69aeec620' => 
    array (
      0 => '/project/vpn/whmcs/admin/templates/licenseerror.tpl',
      1 => 1481670844,
      2 => 'file',
    ),
  ),
...
function content_58f388d270d0c8_35070087 ($_smarty_tpl) {
?>
<!DOCTYPE html>
<html lang="en">
    <head>
...
$_smarty_tpl->tpl_vars['pageTitle']->value = 'License Suspended'; $_smarty_tpl->tpl_vars['pageTitle']->nocache = null;
} else $_smarty_tpl->tpl_vars['pageTitle'] = new Smarty_Variable('License Suspended', null);
$_smarty_tpl->ext->_updateScope->updateScope($_smarty_tpl, 'pageTitle', 0);?>
        <?php } elseif ($_smarty_tpl->tpl_vars['licenseError']->value == "pending") {?>
            <?php if (isset($_smarty_tpl->tpl_vars['pageTitle'])) {$_smarty_tpl->tpl_vars['pageTitle'] = clone $_smarty_tpl->tpl_vars['pageTitle'];
$_smarty_tpl->tpl_vars['pageTitle']->value = 'License Key Pending'; $_smarty_tpl->tpl_vars['pageTitle']->nocache = null;
} else $_smarty_tpl->tpl_vars['pageTitle'] = new Smarty_Variable('License Key Pending', null);
$_smarty_tpl->ext->_updateScope->updateScope($_smarty_tpl, 'pageTitle', 0);?>
        <?php } elseif ($_smarty_tpl->tpl_vars['licenseError']->value == "invalid") {?>
            <?php if (isset($_smarty_tpl->tpl_vars['pageTitle'])) {$_smarty_tpl->tpl_vars['pageTitle'] = clone $_smarty_tpl->tpl_vars['pageTitle'];
$_smarty_tpl->tpl_vars['pageTitle']->value = 'Invalid License'; $_smarty_tpl->tpl_vars['pageTitle']->nocache = null;
} else $_smarty_tpl->tpl_vars['pageTitle'] = new Smarty_Variable('Invalid License', null);
$_smarty_tpl->ext->_updateScope->updateScope($_smarty_tpl, 'pageTitle', 0);?>
        <?php } elseif ($_smarty_tpl->tpl_vars['licenseError']->value == "expired") {?>
            <?php if (isset($_smarty_tpl->tpl_vars['pageTitle'])) {$_smarty_tpl->tpl_vars['pageTitle'] = clone $_smarty_tpl->tpl_vars['pageTitle'];
$_smarty_tpl->tpl_vars['pageTitle']->value = 'Expired License'; $_smarty_tpl->tpl_vars['pageTitle']->nocache = null;
} else $_smarty_tpl->tpl_vars['pageTitle'] = new Smarty_Variable('Expired License', null);
$_smarty_tpl->ext->_updateScope->updateScope($_smarty_tpl, 'pageTitle', 0);?>
        <?php } elseif ($_smarty_tpl->tpl_vars['licenseError']->value == "version") {?>
            <?php if (isset($_smarty_tpl->tpl_vars['pageTitle'])) {$_smarty_tpl->tpl_vars['pageTitle'] = clone $_smarty_tpl->tpl_vars['pageTitle'];
$_smarty_tpl->tpl_vars['pageTitle']->value = 'Renewal Required'; $_smarty_tpl->tpl_vars['pageTitle']->nocache = null;
} else $_smarty_tpl->tpl_vars['pageTitle'] = new Smarty_Variable('Renewal Required', null);
$_smarty_tpl->ext->_updateScope->updateScope($_smarty_tpl, 'pageTitle', 0);?>
        <?php } elseif ($_smarty_tpl->tpl_vars['licenseError']->value == "noconnection") {?>
            <?php if (isset($_smarty_tpl->tpl_vars['pageTitle'])) {$_smarty_tpl->tpl_vars['pageTitle'] = clone $_smarty_tpl->tpl_vars['pageTitle'];
$_smarty_tpl->tpl_vars['pageTitle']->value = 'Connection Error'; $_smarty_tpl->tpl_vars['pageTitle']->nocache = null;
} else $_smarty_tpl->tpl_vars['pageTitle'] = new Smarty_Variable('Connection Error', null);
$_smarty_tpl->ext->_updateScope->updateScope($_smarty_tpl, 'pageTitle', 0);?>
        <?php } elseif ($_smarty_tpl->tpl_vars['licenseError']->value == "change") {?>
            <?php if (isset($_smarty_tpl->tpl_vars['pageTitle'])) {$_smarty_tpl->tpl_vars['pageTitle'] = clone $_smarty_tpl->tpl_vars['pageTitle'];
$_smarty_tpl->tpl_vars['pageTitle']->value = 'Update License Key'; $_smarty_tpl->tpl_vars['pageTitle']->nocache = null;
} else $_smarty_tpl->tpl_vars['pageTitle'] = new Smarty_Variable('Update License Key', null);
$_smarty_tpl->ext->_updateScope->updateScope($_smarty_tpl, 'pageTitle', 0);?>
        <?php }?>
