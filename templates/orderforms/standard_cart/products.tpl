...
<div id="order-standard_cart">
  ...
  <section class="order">
    <div class="container">
      <div class="row order-header text-center">
        <div class="col-sm-12">
          <h2>影梭官网</h2>
          <p>老牌 科学上网 服务商，品牌保障，稳定可靠，值得信赖</p>
        </div>
      </div>
      ...
      <div class="col-md-6">
        <div class="order-cart">
          ...
          <div class="order-price text-center">
              ...
              <a href="cart.php?a=add&{if $product.bid}bid={$product.bid}{else}pid={$product.pid}{/if}" class="btn btn-success">
      ...
      <!-- <div class="row">
        <div class="col-sm-6">
          <div class="order-cart">
            ...
            <div class="order-desc">
              <ul>
                <li>类型：<span class="green">此款为月付产品 按流量计费 基础流量2G</span></li>
                <li>流量：以GB为单位，2元/ GB。</li>
                <li>带宽：1000M 独享高速穿越</li>
                <li>机房：香港（机房不断增加，请以购买后的线路为准）</li>
                <li><span class="green">所有线路均支持U D P转发。按需购买。不限设备。</span></li>
                <li>同一时间同一个账号允许多个终端同时使用.</li>
                <li>未越狱 iOS 用户需要另外购买第三方客户端。</li>
              </ul>
            </div>
            <div class="order-price text-center">
              <p>起价 <br><span class="order-price-sp">21.00CNY</span><br> 月付</p>
              <a href="" class="btn btn-success"><i class="fa fa-shopping-cart"></i>现在订购</a>
            </div>
          </div>
        </div>
        <div class="col-sm-6">
          <div class="order-cart">
            ...
            <div class="order-desc">
              <ul>
                <li>类型：<span class="green">此款为年付产品 限时促销，每天限售200个，售完为止。</span></li>
                <li>流量：不限流量</li>
                <li>宽：1000M 独享高速穿越</li>
                <li>机房：美国、日本、新加坡、香港（机房不断增加，请以购买后的线路为准）</li>
                <li><span class="green">所有线路均支持U D P转发。按需购买。不限设备。</span></li>
                <li>同一时间同一个账号允许多个终端同时使用.</li>
                <li>未越狱 iOS 用户需要另外购买第三方客户端。</li>
              </ul>
