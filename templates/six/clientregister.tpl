                ...
                <div class="row">
                    ...
                    <div class="col-md-6 hide">
                      ...
                      <div class="form-group hide">
                          ...
                          <input type="text" name="companyname" id="companyname" value="缺省" class="form-control"/>
                      </div>
                        <div class="form-group hide">
                            <label for="address1" class="control-label">{$LANG.clientareaaddress1}</label>
                            <input type="text" name="address1" id="address1" value="缺省" class="form-control" {if !in_array('address1', $optionalFields)}required{/if} />
                        </div>

                        <div class="form-group hide">
                            <label for="address2" class="control-label">{$LANG.clientareaaddress2}</label>
                            <input type="text" name="address2" id="address2" value="缺省" class="form-control"/>
                        </div>

                        <div class="form-group hide">
                            <label for="city" class="control-label">{$LANG.clientareacity}</label>
                            <input type="text" name="city" id="city" value="缺省" class="form-control" {if !in_array('city', $optionalFields)}required{/if} />
                        </div>

                        <div class="form-group hide">
                            <label for="state" class="control-label">{$LANG.clientareastate}</label>
                            <input type="text" name="state" id="state" value="缺省" class="form-control" {if !in_array('state', $optionalFields)}required{/if} />
                        </div>

                        <div class="form-group hide">
                            <label for="postcode" class="control-label">{$LANG.clientareapostcode}</label>
                            <input type="text" name="postcode" id="postcode" value="00000000" class="form-control" {if !in_array('postcode', $optionalFields)}required{/if} />
                        </div>
