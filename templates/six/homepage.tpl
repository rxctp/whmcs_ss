<!-- modal start-->
        ...
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a style="float:right" href="/">忘记用户名？</a>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="root">
            ...
            <div class="main-content">
                        ...
                        <div id="carousel-example-captions" class="carousel slide">
                            ...
                            <div class="carousel-inner height_500" role="listbox">
                                <div class="item index_item">
                                    ...
                                    <div class="col-lg-4 col-lg-offset-1 col-sm-4 col-sm-offset-1 index_banner_third_2 index_banner_img_2"><img src="./img/slider-4.png" class="img-responsive center-block"></div>
                                </div>
                                <div class="item index_item height_500">
                                    <div class="col-lg-5 col-sm-5 index_banner_third index_banner_img_2"><img src="./img/slider-2.png" class="img-responsive center-block"></div>
                                ...
                                <div class="item index_item height_500 active">
                                    <div class="col-lg-5 col-sm-5 index_banner_third index_banner_img_2"><img src="./img/slider-3.png" class="img-responsive center-block"></div>
                                    <div class="col-lg-6 col-lg-offset-1 col-md-6 col-md-offset-1 col-sm-6 col-sm-offset-1 index_banner">
                            ...
                            <div class="hju" style="width: 100%; margin-top: -11px;"><img src="./img/xian.png" style="width: 100%; height: 1px;"></div>
                        </div>
                        <a class="left carousel-control banner_a_left" href="/" role="button" data-slide="prev" style="width: 50px;"><span class="icon" aria-hidden="true"><img src="./img/prevBtn.png"></span></a>
                        <a class="right carousel-control banner_a_right" href="" role="button" data-slide="next" style="width: 50px;"><span class="icon" aria-hidden="true"><img src="./img/nextBtn.png"></span></a>
                    </div>
                </div>
                <section class="container index_margin">
                    ...
                    <div class="col-lg-6">
                        <div class="feature-box-a"><img src="./img/locking-ico.png" class="feature-img">
                            <div class="feature-text-a">
                                <h4>安全隐私必备</h4>
                                <p>通过建立安全通道连接，能有效加密网络通信，确保网络数据的完整准确性，避免在不安全的网络环境下（如公共Wi-Fi）通信记录被黑客窃取利用。</p>
                            </div>
                        </div>
                        <div class="feature-box-a"><img src="./img/imac-ico.png" class="feature-img">
                            <div class="feature-text-a">
                                <h4>设备支持广泛</h4>
                                <p>Windows、Mac、iOS、Android 原生支持，除手动设置使用外，还提供专用客户端软件，运行资源占用小，使用简单无需复杂配置，建议优先选用。</p>
                            </div>
                        </div>
                        <div class="feature-box-b"><img src="./img/server-ico.png" class="feature-img">
                    ...
                    <div class="col-lg-6">
                        <div class="feature-box-a"><img src="./img/earth-ico.png" class="feature-img">
                            <div class="feature-text-a">
                                <h4>高速服务节点</h4>
                                <p>采用企业级商用服务器群组，与知名IDC服务商合作，无论线路带宽、硬件资源都能得到有效保障。运行于全球各地优质机房，提供高速互联体验。</p>
                            </div>
                        </div>
                        <div class="feature-box-a"><img src="./img/connection-ico.png" class="feature-img">
                            <div class="feature-text-a">
                                <h4>连接协议丰富</h4>
                                <p>支持多种虚拟专用网协议，加密性强，拥有良好的平台与网络兼容性。在提供更多选择的同时，也提高了网络连接稳定性，让您拥有更舒心的网络体验。</p>
                            </div>
                        </div>
                        <div class="feature-box-b" style="margin: 0;"><img src="./img/support-ico.png" class="feature-img">
                            <div class="feature-text-a">
                                <h4>售后支持完善</h4>
                ...
                <div class="row"> <img src="./img/xian.png" class="img-responsive center-block" style="height: 1px;"> </div>
                            ...
                            <div class="carousel-inner" style="height: auto;">
                                <div class="item active" style="height: auto;">
                                    <div class="big-testimonial-wrapper">
                                        <div class="big-testimonial-image"><img src="./img/user-rating-1.jpg" alt=""></div>
                                ...
                                <div class="item" style="height: auto;">
                                    <div class="big-testimonial-wrapper">
                                        <div class="big-testimonial-image"><img src="./img/user-rating-2.jpg" alt=""></div>
                                ...
                                <div class="item" style="height: auto;">
                                    <div class="big-testimonial-wrapper">
                                        <div class="big-testimonial-image"><img src="./img/user-rating-3.jpg" alt=""></div>
                        ...
                        <div class="container">
                            <div class="row">
                                ...
                                <div class="col-lg-5 col-md-5 col-sm-5 text-right">
                                    <a href="https://get.greenjsqcn.com/reg.html">
                ...
                <div class="modal fade" id="app_qr" role="dialog">
                    <div class="modal-dialog modal-sm">
                        <div class="modal-content">
                            ...
                            <div class="modal-body" style="padding: 20px 35px;"> <img src="./img/app-index.png" border="0" alt="Android APP" style="width: 100%;"> </div>
    ...
    <footer>
        ...
        <div class="container" style="margin-top: 20px;">
            <img src="./img/appstore-ico.png" alt="App Store" class="footer-appdl" style="margin-right: 30px;">
            <img src="./img/playstore-ico.png" alt="Google Play" class="footer-appdl">
        </div>
    </footer>
